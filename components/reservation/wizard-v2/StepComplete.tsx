    ...
    if (reservation.status === "CONFIRMED") {
        return (
            <div className="card p-10 text-center max-w-lg mx-auto">
                ...
                <p className="text-xl font-bold text-title mb-2">예약이 완료되었습니다.</p>
                <p className="text-sm text-muted mb-8">예약 정보를 확인하시고 안전하게 보관해주세요.</p>
                ...
                <div className="card p-5 text-left mb-8">
                    <div className="space-y-2.5 text-sm">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="text-title font-medium">{reservation.check_in}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-muted">체크아웃</span>
                            <span className="text-title font-medium">{reservation.check_out}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-muted">예약자</span>
                            <span className="text-title font-medium">{reservation.guest_name}</span>
                        </div>
                        ...
                        <div className="flex justify-between pt-2.5 border-t border-gray-100">
                            ...
                            <span className="text-primary font-bold">{formatWon(reservation.total_price)}</span>
                        </div>
                    </div>
                </div>

                <p className="text-xs text-muted mb-6">예약 관련 안내는 입력하신 이메일로 발송됩니다.</p>
                ...
                <div className="flex gap-3">
                    ...
                    <button type="button" onClick={() => router.push("/")} className="btn-ghost flex-1">
                        홈으로
                    </button>
                </div>
            </div>
            ...
            <div className="card p-6 max-w-lg mx-auto">
                ...
                <div className="bg-title rounded-lg p-5">
                    ...
                    <div className="flex justify-between items-baseline mb-5">
                        ...
                        <span className="text-xl font-bold text-primary">{formatWon(reservation.total_price)}</span>
                    </div>
